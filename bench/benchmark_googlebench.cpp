...
BENCHMARK_DEFINE_F(RandomFixture, quick_sort)
(benchmark::State &st) {
  for (auto _ : st) {
    sri::quick_sort(m_unsorted.begin(), m_unsorted.end());
  }
}

BENCHMARK_DEFINE_F(RandomFixture, iterative_quick_sort)
(benchmark::State &st) {
  for (auto _ : st) {
    sri::quick_sort_i(m_unsorted.begin(), m_unsorted.end());
  }
}
...
BENCHMARK_REGISTER_F(RandomFixture, quick_sort)->Arg(SIZE);
BENCHMARK_REGISTER_F(RandomFixture, iterative_quick_sort)->Arg(SIZE);
...
BENCHMARK_DEFINE_F(AscendingFixture, quick_sort)
(benchmark::State &st) {
  for (auto _ : st) {
    sri::quick_sort(m_unsorted.begin(), m_unsorted.end());
  }
...
BENCHMARK_DEFINE_F(AscendingFixture, iterative_quick_sort)
(benchmark::State &st) {
  for (auto _ : st) {
    sri::quick_sort_i(m_unsorted.begin(), m_unsorted.end());
  }
...
BENCHMARK_REGISTER_F(AscendingFixture, quick_sort)->Arg(SIZE);
BENCHMARK_REGISTER_F(AscendingFixture, iterative_quick_sort)->Arg(SIZE);
...
BENCHMARK_DEFINE_F(DesceningFixture, quick_sort)
(benchmark::State &st) {
  for (auto _ : st) {
    sri::quick_sort(m_unsorted.begin(), m_unsorted.end());
  }
...
BENCHMARK_DEFINE_F(DesceningFixture, iterative_quick_sort)
(benchmark::State &st) {
  for (auto _ : st) {
    sri::quick_sort_i(m_unsorted.begin(), m_unsorted.end());
  }
...
BENCHMARK_REGISTER_F(DesceningFixture, quick_sort)->Arg(SIZE);
BENCHMARK_REGISTER_F(DesceningFixture, iterative_quick_sort)->Arg(SIZE);
